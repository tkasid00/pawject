...
@Repository
public interface ExecHashtagRepository extends JpaRepository<ExecHashtag, Long> {

    @Query("SELECT DISTINCT h FROM ExecHashtag h JOIN FETCH h.execPosts WHERE h.name = :name")
