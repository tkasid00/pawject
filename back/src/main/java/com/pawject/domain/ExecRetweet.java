...
@Table(name= "EXECRETWEETS",
	uniqueConstraints = @UniqueConstraint(
		...
		columnNames = {"USERID" , "ORIGINAL_POST_ID"}
	)
)
@Getter  @Setter @NoArgsConstructor
public class ExecRetweet {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE , generator = "execretweets_seq")  //시퀀스 사용
	@SequenceGenerator(name = "execretweets_seq", sequenceName = "EXECRETWEETS_SEQ" , allocationSize = 1) 
	private Long id; //PK
